...
export default function Footer() {
  return (
    <footer className="bg-[#080c14] border-t border-slate-800 text-slate-400 py-12 px-4 md:px-10 text-xs">
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-3">
          <h4 className="text-white font-bold uppercase tracking-wider text-[11px]">Navigation</h4>
        ...
        {/* Community Column */}
        <div className="space-y-3">
          <h4 className="text-white font-bold uppercase tracking-wider text-[11px]">Community & Ecosystem</h4>
          <ul className="space-y-2">
        ...
        {/* Legal & Copyright */}
        <div className="space-y-3">
          <h4 className="text-white font-bold uppercase tracking-wider text-[11px]">System Status</h4>
