    ...
    <div className="w-full bg-[#f7f9ff] py-12 md:py-16">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 space-y-16">
        ...
        <section className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-xl text-[#3f4851] leading-relaxed font-medium">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm space-y-4">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-[#171c21]">Our Core Mission</h2>
            <p className="text-sm md:text-base text-[#3f4851] leading-relaxed font-normal">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm space-y-4">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-[#171c21]">Why DevConnect?</h2>
            <p className="text-sm md:text-base text-[#3f4851] leading-relaxed font-normal">
        ...
        <section className="space-y-8">
          <div className="text-center max-w-xl mx-auto space-y-2">
            <h2 className="text-2xl md:text-4xl font-extrabold text-[#171c21] tracking-tight">Platform Capabilities</h2>
            <p className="text-base text-[#3f4851] font-medium">Explore the key features powering the DevConnect ecosystem.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-3 shadow-xs hover:border-primary-container transition-all">
              ...
              <h3 className="text-lg font-bold text-[#171c21]">Interactive Showcases</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-3 shadow-xs hover:border-primary-container transition-all">
              <span className="material-symbols-outlined text-primary-container text-4xl">forum</span>
              <h3 className="text-lg font-bold text-[#171c21]">Database Discussions</h3>
              <p className="text-sm text-gray-600 leading-relaxed font-normal">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-3 shadow-xs hover:border-primary-container transition-all">
              <span className="material-symbols-outlined text-primary-container text-4xl">account_circle</span>
              <h3 className="text-lg font-bold text-[#171c21]">Developer Profiles</h3>
              <p className="text-sm text-gray-600 leading-relaxed font-normal">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-3 shadow-xs hover:border-primary-container transition-all">
              ...
              <h3 className="text-lg font-bold text-[#171c21]">Real-Time Metrics</h3>
              <p className="text-sm text-gray-600 leading-relaxed font-normal">
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-8 md:p-12 shadow-sm space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#171c21] tracking-tight">Technical Architecture & Stack</h2>
              <p className="text-sm text-gray-500 font-medium mt-1">Built with modern enterprise-grade web standards and security best practices.</p>
            </div>
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-xl text-xs md:text-sm font-bold shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-lg font-bold text-[#171c21]">
                <span className="material-symbols-outlined text-primary-container text-2xl">laptop_mac</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-lg font-bold text-[#171c21]">
                <span className="material-symbols-outlined text-primary-container text-2xl">database</span>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-10 md:p-14 text-center relative overflow-hidden shadow-sm space-y-6">
          <div className="relative z-10 space-y-3 max-w-2xl mx-auto">
            ...
            <p className="text-base text-[#3f4851] font-medium">
            ...
            <div className="pt-2 flex flex-col sm:flex-row justify-center items-center gap-4">
              <Link
                to="/explore"
                className="w-full sm:w-auto bg-primary-container hover:bg-sky-400 text-white font-bold text-sm px-8 py-3.5 rounded-xl shadow-md transition-all"
              >
                Explore Community Projects
              </Link>
              <Link
                to="/my-projects"
                className="w-full sm:w-auto border border-gray-300 bg-white text-black font-bold text-sm px-8 py-3.5 rounded-xl hover:bg-gray-50 transition-all shadow-xs"
              >
